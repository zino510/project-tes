...
$current_datetime_utc = '2025-03-10 15:15:48';
...
// Ambil data pesanan dengan informasi tambahan (alamat dan nomor telepon)
$pesanan_query = "
    SELECT 
...
<head>
    ...
    <style>
        ...
        /* Style untuk status tidak tersedia */
        .text-unavailable {
            color: #94a3b8;
            font-style: italic;
        }

        /* Hover effect untuk informasi kontak */
        .contact-info:hover {
                ...
                <div class="modal-content bg-white w-full max-w-2xl rounded-xl shadow-2xl">
                    ...
                    <div class="px-6 py-4">
                        <div class="space-y-4">
                            ...
                            <!-- Buyer Information dengan nomor telepon dan alamat -->
                            <div class="bg-gray-50 rounded-lg p-4">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <p class="flex items-center text-gray-600">
                                        ...
                                        <span class="ml-2">
                                            <?php 
                                            if (!empty($row['buyer_phone'])) {
                                                echo htmlspecialchars($row['buyer_phone']);
                                            } else {
                                                echo '<span class="text-gray-400">Tidak ada nomor telepon</span>';
                                            }
                                            ?>
                                        </span>
                                    </p>
                                    <div class="flex items-start text-gray-600">
                                        <i class="fas fa-map-marker-alt w-6 text-gray-400 mt-1"></i>
                                        <span class="ml-2">
                                            <?php 
                                            if (!empty($row['shipping_address'])) {
                                                echo nl2br(htmlspecialchars($row['shipping_address']));
                                            } else {
                                                echo '<span class="text-gray-400">Tidak ada alamat pengiriman</span>';
                                            }
                                            ?>
                                        </span>
                                    </div>
